...
class FrontendContractTest(unittest.TestCase):
    ...
    def test_dual_resource_timelines_share_range_and_refresh(self):
        ...
        self.assertIn('data-scope="GLOBAL"', self.html)
        self.assertIn('data-scope="RUSSIA"', self.html)
        self.assertIn('S.timelineFilters[scope]', self.js)
        self.assertIn('function timelineReason(point,state,isStale,staleAfter)', self.js)
