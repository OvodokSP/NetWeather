...
CATALOG_GROUPS = [
    {
        ...
        "color": "#35D89A",
        "source": "Semrush Traffic Analytics · Россия",
        "as_of": "август 2026",
        "description": "Популярные российские сервисы; соцсети и видео вынесены в отдельную группу без дублей.",
    },
    {
        "key": "INTERNATIONAL",
        "title": "Международные сервисы",
        "color": "#55C7FF",
        "source": "Similarweb · Top Websites Worldwide",
        "as_of": "август 2026",
        "description": "Популярные международные сайты; соцсети и инфраструктура исключены, чтобы не дублировать группы.",
    },
    {
        "key": "MESSENGERS",
        ...
        "source": "Similarweb · Top Websites Worldwide",
        "as_of": "август 2026",
        "description": "Крупнейшие социальные, видео- и коммуникационные платформы без повторов из других групп.",
    },
    {
        "key": "INFRASTRUCTURE",
        "title": "Инфраструктура",
        "color": "#FFAD4D",
        "source": "W3Techs · Reverse Proxy Market Share",
        "as_of": "сентябрь 2026",
