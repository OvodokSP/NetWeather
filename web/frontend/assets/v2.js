...
function setup(){
  ...
  q("#tokenForm").onsubmit=function(e){e.preventDefault();localStorage.setItem("netweather_token",q("#tokenInput").value.trim());q("#tokenDialog").close();renderSettings();toast("API-токен сохранён")};
