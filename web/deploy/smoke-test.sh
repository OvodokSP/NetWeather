...
curl -fsS "$BASE_URL/assets/dashboard.js?v=0.4.0-hardware-free" >/dev/null; ok 'GET /assets/dashboard.js'
curl -fsS "$BASE_URL/assets/dashboard.css?v=0.4.0-hardware-free" >/dev/null; ok 'GET /assets/dashboard.css'
