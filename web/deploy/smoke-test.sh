...
curl -fsS "$BASE_URL/assets/dashboard.js?v=0.3.2" >/dev/null; ok 'GET /assets/dashboard.js'
curl -fsS "$BASE_URL/assets/dashboard.css?v=0.3.2" >/dev/null; ok 'GET /assets/dashboard.css'
