...
- problem-first Overview: здоровье, свежесть данных, доступные ресурсы, типичный отклик, синхронные шкалы доступности GLOBAL/RUSSIA, события и быстрый фильтр проблем;
- обе шкалы обновляются одним объединённым снимком каждые 10 секунд и поддерживают периоды 1ч/6ч/24ч/7д с цветными сегментами доступности;
